            ...
            <table class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th><?php echo $listContact['PhoneNumber'] ?></th>
                        <th>
                            <a href="./delete_section.php?ID=<?php echo $listContact['ID'] ?>" ><i class="fa-solid fa-trash " style="color: #d51010;"></i></a>
